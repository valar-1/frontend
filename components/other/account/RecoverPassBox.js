                            ...
                            <div className="billing-form-item mb-0">
                                <div className="billing-title-wrap">
                                    ...
                                    <p className="font-size-16 font-weight-medium">Enter the email of your account
                                        ...
                                        issue about reset password <Link href="/contact" className="color-text">contact us</Link>
                                    </p>
                                </div>
                                    ...
                                    <div className="contact-form-action">
                                        <form method="post">
                                            ...
                                            <p className="font-weight-medium">
                                                <Link href="/login" className="color-text">Login </Link>
                                                or
                                                <Link href="/SignUp" className="color-text"> Register</Link>
                                            </p>
                                        </form>
                                    </div>
                                </div>
