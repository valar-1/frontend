                            ...
                            <div className="col-lg-12">
                                <div className="dashboard-nav d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div className="btn-box">
                                        <Link href="/listings/AddListing" className="theme-btn"><span className="la"><AiOutlinePlusCircle /></span> create listing</Link>
                                        <Link href="/" className="theme-btn ml-1"><span className="la"><AiOutlinePoweroff /></span> sign out</Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-12">
                                                ...
                                                return (
                                                    <div key={i} className="col-lg-4 column-td-6">
                                                        <div className="card-item">
                                                            <Link href={item.cardLink} className="card-image-wrap">
