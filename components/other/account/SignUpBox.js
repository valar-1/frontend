                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <div className="custom-checkbox d-block mr-0">
                                            ...
                                            <label htmlFor="chb13">I Agree to Dirto's <Link href="/" className="color-text">Privacy Policy</Link></label>
                                        </div>
                                        <div className="custom-checkbox d-block mr-0">
                                            <input type="checkbox" id="chb14" />
                                            <label htmlFor="chb14">I Agree to Dirto's <Link href="/" className="color-text">Terms of Services</Link></label>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                ...
                                <div className="col-lg-12">
                                    <p className="font-weight-medium">
                                        Already have an account? <Link href="/login" className="color-text">Login</Link>
                                    </p>
                                </div>
                            </div>
                        </form>
