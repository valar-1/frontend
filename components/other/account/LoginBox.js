                    ...
                    <div className="contact-form-action">
                        <form method="post">
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <div className="form-group">
                                        <div className="custom-checkbox mr-0 d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                <Link href="/RecoverPassword" className="color-text font-weight-medium">
                                                    Forgot password?
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-12">
                                    <p className="font-weight-medium">Not a member? <Link href="/SignUp" className="color-text"> Register</Link></p>
                                </div>
                            </div>
                        </form>
                    </div>
